...
function SignUp() {
  ...
  return (
    <>
      <div className='container my-3 py-4' style={{ background:"#DCD6F7", borderRadius: "10px", height: "100%", width: "60%" }}>
      ...
      <div className="container my-3 my-3 py-2 " style={{ background: "#DCD6F7", borderRadius: "10px", height: "100%", width: "60%" }}>
        <div className="d-flex justify-content-center">
        Have an account?  <Link type="button" to="/signup" style={{ textDecoration: "none" }}>Log in</Link>
        </div>
      </div>
    </>
  )
